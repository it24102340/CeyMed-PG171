    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/user/**", "/css/**", "/js/**", "/images/**", "/uploads/**", "/h2-console/**", "/policies", "/login", "/signup", "/feedback/**", "/policy/**", "/purchase/**", "/article/**").permitAll()
                        .requestMatchers("/admin/**", "/feedback/admin/**").hasRole("ADMIN")
